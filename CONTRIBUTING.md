...
some other ruleset that depends on `skills.bzl`, or in a nested
...
```sh
OVERRIDE="--override_module=skills.bzl=$(pwd)"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `skills.bzl` on your system will point to this folder.
...
https://github.com/ewhauser/skills.bzl/actions/workflows/tag.yaml
